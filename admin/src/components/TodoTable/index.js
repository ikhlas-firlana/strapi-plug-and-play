...
export const TodoCheckbox = ({ value, checkboxID, callback, disabled }) => {
...
export const TodoRow = ({ todo, toggleTodo, deleteTodo, editTodo }) => {
  const [inputValue, setInputValue] = React.useState(todo.name);
...
const TodoTable = ({ todoData, toggleTodo, deleteTodo, editTodo, setShowModal }) => {
  return (
    <Box
      background="neutral0"
      hasRadius={true}
